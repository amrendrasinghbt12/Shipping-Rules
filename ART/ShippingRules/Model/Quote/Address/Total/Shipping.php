...
namespace ART\ShippingRules\Model\Quote\Address\Total;
        ...
        if ($method) {
            foreach ($address->getAllShippingRates() as $rate) {
                if ($rate->getCode() == $method) {
                    ...
                    $baseAmountPrice = ($checkoutSession->getCustomShippingprice()) ? $checkoutSession->getCustomShippingprice() : $rate->getPrice();
                    ...
                    $total->setBaseTotalAmount($this->getCode(), $baseAmountPrice);
                    $shippingDescription = $rate->getCarrierTitle() . ' - ' . $rate->getMethodTitle();
                    $address->setShippingDescription(trim($shippingDescription, ' -'));
                    $total->setBaseShippingAmount($baseAmountPrice);
